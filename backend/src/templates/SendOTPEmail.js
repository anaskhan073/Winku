    ...
    <body style="font-family: Arial, sans-serif; margin: 0; padding: 0; background-color: #f4f4f4; color: #333;">
      ...
      <div className="container" style="max-width: 600px; margin: 30px auto; background: #ffffff; border-radius: 8px; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.1); overflow: hidden; border: 1px solid #ddd;">
        ...
        <div className="content" style="padding: 25px; line-height: 1.8; text-align: center;">
          ...
          <div className="verification-code" style="display: inline-block; margin: 20px 0; font-size: 22px; color: #4cb4fd; background: #eef2ff; border: 1px dashed #4cb4fd; padding: 12px 20px; text-align: center; border-radius: 6px; font-weight: bold; letter-spacing: 2px;">
            ${verificationCode}
          </div>
