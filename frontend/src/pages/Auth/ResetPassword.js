                    ...
                    <div className="form-box">
                        ...
                        <div className="form">
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="input-wrapper">
                                    <input type={showconfirmPassword ? "text" : "password"} id="password" placeholder=" " value={formData.confirmPassword} onChange={(e) => setFormData({ ...formData, confirmPassword: e.target.value })} />
                                ...
                                <div className="buttons flex gap-2">
                                    <button className="submit-btn" disabled={isloding}>{isloding ? 'Submit...' : 'Submit'}</button>
                                </div>
                            </form>
                        </div>
                    </div>
