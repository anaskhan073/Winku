            ...
            <div className="form">
              <form action="#">
                ...
                <div class="input-wrapper">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" className="icon" width={30} height={30} viewBox="0 0 24 24"><g fill="none" stroke="currentColor" strokeWidth={1.5}><circle cx={12} cy={6} r={4}></circle><path d="M20 17.5c0 2.485 0 4.5-8 4.5s-8-2.015-8-4.5S7.582 13 12 13s8 2.015 8 4.5Z"></path></g></svg>
                ...
                <SocialLogin />
                <p className="mb-2">Already have an account? <Link to='/login' className="blue-a">Login</Link></p>
